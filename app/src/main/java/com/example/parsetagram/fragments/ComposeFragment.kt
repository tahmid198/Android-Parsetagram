...
class ComposeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Set on click listeners and handle set up logic

        ivPreview = view.findViewById(R.id.imageView)

        // Fragments dont have a findViewById, but what we can do is prepend it by a view
        view.findViewById<Button>(R.id.btnSubmit).setOnClickListener {
            ...
            if(photoFile != null) {
                ...
                Log.e(MainActivity.TAG, "Error while picking image")
                Toast.makeText(requireContext(), "Image was not picked", Toast.LENGTH_SHORT)
            }
        }
    ...
    fun submitPost(description: String, user: ParseUser, file: File) {
        ...
        post.saveInBackground{ exception ->
            if (exception != null) {
                ...
                Toast.makeText(requireContext(), "Error submitting post", Toast.LENGTH_SHORT)
            } else {
                Log.i(MainActivity.TAG, "Successfully saved post")
                view?.findViewById<EditText>(R.id.et_description)?.text?.clear()  // Resetting the edittext field to empty
                view?.findViewById<ImageView>(R.id.imageView)?.setImageDrawable(null)   // Reset the image to be empty
                Toast.makeText(requireContext(), "Post Successful!", Toast.LENGTH_SHORT)
            }
        }
    }
